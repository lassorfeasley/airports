...
document.addEventListener("DOMContentLoaded", async function () {
    ...
    const popularAirports = [
        { iata_code: "SFO", name: "San Francisco International Airport" },
        { iata_code: "JFK", name: "John F. Kennedy International Airport" },
        { iata_code: "LGA", name: "LaGuardia Airport" },
    ...
    attachSearchEvent('origin-dropdown', airportData);
    attachSearchEvent('destination-dropdown', airportData);
});
